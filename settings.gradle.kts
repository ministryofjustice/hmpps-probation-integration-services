...
dependencyResolutionManagement {
    versionCatalogs {
        create("libs") {
            ...
            library("aws-query-protocol", "software.amazon.awssdk:aws-query-protocol:2.47.4")
            ...
            library("aws-sts", "software.amazon.awssdk:sts:2.47.4")
            ...
            library("sentry", "io.sentry:sentry-spring-boot-4:8.48.0")
