...
dependencyResolutionManagement {
    versionCatalogs {
        create("libs") {
            ...
            library("aws-query-protocol", "software.amazon.awssdk:aws-query-protocol:2.42.13")
            ...
            library("aws-sts", "software.amazon.awssdk:sts:2.42.13")
            ...
            library("sentry", "io.sentry:sentry-spring-boot-4:8.35.0")
