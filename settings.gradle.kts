...
dependencyResolutionManagement {
    versionCatalogs {
        create("libs") {
            ...
            library("aws-sts", "software.amazon.awssdk:sts:2.31.1")
            ...
            library("microsoft-graph", "com.microsoft.graph:microsoft-graph:6.32.0")
            ...
            library("sentry", "io.sentry:sentry-spring-boot-starter-jakarta:8.4.0")
