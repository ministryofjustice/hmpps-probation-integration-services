...
dependencyResolutionManagement {
    versionCatalogs {
        create("libs") {
            ...
            library("aws-query-protocol", "software.amazon.awssdk:aws-query-protocol:2.41.14")
            ...
            library("aws-sts", "software.amazon.awssdk:sts:2.41.14")
            ...
            library("mockito-kotlin", "org.mockito.kotlin:mockito-kotlin:6.2.2")
