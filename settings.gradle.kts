...
dependencyResolutionManagement {
    versionCatalogs {
        create("libs") {
            ...
            library("aws-query-protocol", "software.amazon.awssdk:aws-query-protocol:2.32.14")
            ...
            library("aws-sts", "software.amazon.awssdk:sts:2.32.14")
            ...
            library("microsoft-graph", "com.microsoft.graph:microsoft-graph:6.48.0")
            ...
            library("sentry", "io.sentry:sentry-spring-boot-starter-jakarta:8.18.0")
