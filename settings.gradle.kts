...
dependencyResolutionManagement {
    versionCatalogs {
        create("libs") {
            ...
            library("aws-s3", "io.awspring.cloud:spring-cloud-aws-starter-s3:3.3.1")
            library("aws-autoconfigure", "io.awspring.cloud:spring-cloud-aws-autoconfigure:3.3.1")
            library("aws-query-protocol", "software.amazon.awssdk:aws-query-protocol:2.31.59")
            library("aws-sns", "io.awspring.cloud:spring-cloud-aws-starter-sns:3.3.1")
            library("aws-sqs", "io.awspring.cloud:spring-cloud-aws-starter-sqs:3.3.1")
            library("aws-starter", "io.awspring.cloud:spring-cloud-aws-starter:3.3.1")
            library("aws-sts", "software.amazon.awssdk:sts:2.31.59")
            ...
            library("microsoft-graph", "com.microsoft.graph:microsoft-graph:6.40.0")
            ...
            library("opensearch-starter", "org.opensearch.client:spring-data-opensearch-starter:1.7.0")
            library(
                "opentelemetry-annotations",
                "io.opentelemetry.instrumentation:opentelemetry-instrumentation-annotations:2.16.0"
            )
            library("sentry", "io.sentry:sentry-spring-boot-starter-jakarta:8.13.2")
