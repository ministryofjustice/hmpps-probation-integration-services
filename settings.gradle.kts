...
dependencyResolutionManagement {
    versionCatalogs {
        create("libs") {
            ...
            library("aws-query-protocol", "software.amazon.awssdk:aws-query-protocol:2.31.56")
            ...
            library("aws-sts", "software.amazon.awssdk:sts:2.31.56")
            ...
            library("opensearch", "org.opensearch.client:opensearch-java:3.1.0")
