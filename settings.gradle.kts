...
dependencyResolutionManagement {
    versionCatalogs {
        create("libs") {
            ...
            library("aws-query-protocol", "software.amazon.awssdk:aws-query-protocol:2.48.3")
            ...
            library("aws-sts", "software.amazon.awssdk:sts:2.48.3")
            ...
            library("microsoft-graph", "com.microsoft.graph:microsoft-graph:6.66.1")
            library("mockito-inline", "org.mockito:mockito-inline:5.2.0")
            library("mockito-kotlin", "org.mockito.kotlin:mockito-kotlin:6.3.0")
            library("notify", "uk.gov.service.notify:notifications-java-client:6.0.1-RELEASE")
            library("opensearch", "org.opensearch.client:opensearch-java:3.9.0")
            library("opensearch-starter", "org.opensearch.client:spring-data-opensearch-starter:3.1.0")
            library(
                "opentelemetry-annotations",
                "io.opentelemetry.instrumentation:opentelemetry-instrumentation-annotations:2.29.0"
            )
            library("sentry", "io.sentry:sentry-spring-boot-4:8.49.0")
