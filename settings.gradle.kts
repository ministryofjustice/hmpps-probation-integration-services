...
dependencyResolutionManagement {
    versionCatalogs {
        create("libs") {
            ...
            library("aws-sts", "software.amazon.awssdk:sts:2.26.5")
            library("aws-query-protocol", "software.amazon.awssdk:aws-query-protocol:2.26.4")
            bundle(
                "aws-messaging",
            ...
            library("javax-json", "javax.json:javax.json-api:1.1.2")
            library("glassfish-json", "org.glassfish:javax.json:1.1.2")
        }
    }
}
