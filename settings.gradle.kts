...
dependencyResolutionManagement {
    versionCatalogs {
        create("libs") {
            ...
            library("aws-query-protocol", "software.amazon.awssdk:aws-query-protocol:2.30.36")
            ...
            library("aws-sts", "software.amazon.awssdk:sts:2.30.36")
            ...
            library("microsoft-graph", "com.microsoft.graph:microsoft-graph:6.31.0")
