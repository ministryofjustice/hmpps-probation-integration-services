...
dependencyResolutionManagement {
    versionCatalogs {
        create("libs") {
            ...
            library("aws-query-protocol", "software.amazon.awssdk:aws-query-protocol:2.31.16")
            ...
            library("aws-sts", "software.amazon.awssdk:sts:2.31.16")
            ...
            library("microsoft-graph", "com.microsoft.graph:microsoft-graph:6.34.0")
