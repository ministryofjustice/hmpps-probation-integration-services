...
dependencyResolutionManagement {
    versionCatalogs {
        create("libs") {
            ...
            library("aws-query-protocol", "software.amazon.awssdk:aws-query-protocol:2.29.45")
            ...
            library("aws-sts", "software.amazon.awssdk:sts:2.29.45")
            ...
            library("springdoc", "org.springdoc:springdoc-openapi-starter-webmvc-ui:2.8.1")
