...
class Document(
    ...
    companion object {
        const val SUICIDE_RISK_FORM_URN_PREFIX: String = "urn:hmpps:suicide-risk:"

        fun suicideRiskFormUrn(uuid: UUID): String =
            "$SUICIDE_RISK_FORM_URN_PREFIX$uuid"
    }
}
...
interface DocumentRepository : JpaRepository<Document, Long> {
    ...
    fun findByTableNameAndPrimaryKeyIdInAndSoftDeletedFalse(tableName: String, primaryKeyId: List<Long>): List<Document>
    ...
    @Query(
        ...
        where document.external_reference like 'urn:hmpps:suicide-risk:%'
    ...
    fun findSuicideRiskFormUrnsByEventId(eventId: Long): List<String>
}