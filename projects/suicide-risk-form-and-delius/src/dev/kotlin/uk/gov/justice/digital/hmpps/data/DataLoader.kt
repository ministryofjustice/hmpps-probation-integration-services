...
class DataLoader(dataManager: DataManager) : BaseDataLoader(dataManager) {
    ...
    override fun setupData() {
        ...
        save(ProviderGenerator.N01)
        save(StaffGenerator.DEFAULT)
        save(StaffGenerator.OFFICER_2)
        save(StaffGenerator.OFFICER_NO_USER)
        save(UserGenerator.LIMITED_ACCESS_USER)
        save(UserGenerator.NON_LAO_USER)
        save(UserGenerator.DEFAULT)
        save(UserGenerator.OFFICER_2)
        save(ResponsibleOfficerGenerator.DEFAULT_OFFENDER_MANAGER)
        save(ResponsibleOfficerGenerator.DEFAULT_RESPONSIBLE_OFFICER)
        save(ResponsibleOfficerGenerator.DEFAULT_PRISON_OFFENDER_MANAGER)
        save(ResponsibleOfficerGenerator.DEFAULT_PRISON_RESPONSIBLE_OFFICER)
        ...
        save(ReferenceDataGenerator.AUTHORISED_SRF_EMAIL_DATASET)
        save(ReferenceDataGenerator.SRF_EMAIL_POLICE)
        save(ReferenceDataGenerator.SRF_EMAIL_JUSTICE)
        ...
        save(PersonGenerator.PERSON_NO_USER)
        save(ResponsibleOfficerGenerator.NO_USER_OFFENDER_MANAGER)
