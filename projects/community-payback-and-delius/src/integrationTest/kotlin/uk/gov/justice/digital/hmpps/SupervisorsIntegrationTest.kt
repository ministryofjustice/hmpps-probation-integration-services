...
class SupervisorsIntegrationTest {
    ...
    fun `supervisor by username returned`() {
        mockMvc.get("/supervisors?username=${UserGenerator.DEFAULT_USER.username}") { withToken() }
            ...
            .andExpect {
                content { json("""{"code": "N01P001", "isUnpaidWorkTeamMember": true, "unpaidWorkTeams":[{"code":"N01UPW","description":"N01 UPW Team","provider":{"code":"N01","description":"N01 Provider"}}]}""", JsonCompareMode.STRICT) }
            }
    }
}
