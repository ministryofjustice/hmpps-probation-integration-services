...
object ProviderGenerator {
    ...
    val UNSELECTABLE_PROVIDER = generateProvider(code = "N50", description = "N50 Inactive Provider", selectable = false)
    ...
    val DEFAULT_USER_UNSELECTABLE_PROBATION_AREA = generateProbationAreaUser(UserGenerator.DEFAULT_USER, UNSELECTABLE_PROVIDER)
