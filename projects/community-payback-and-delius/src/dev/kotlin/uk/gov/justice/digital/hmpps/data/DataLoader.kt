...
class DataLoader(dataManager: DataManager) : BaseDataLoader(dataManager) {
    ...
    fun loadUnpaidWorkData() {
        ...
        save(UPWGenerator.UPW_PROJECT_AVAILABILITY_1)
        save(UPWGenerator.UPW_PROJECT_AVAILABILITY_2)
        save(UPWGenerator.DEFAULT_COURT)
        save(UPWGenerator.DEFAULT_OFFENCE)
        ...
        save(UPWGenerator.EVENT_6)
        save(UPWGenerator.EVENT_7)
        ...
        save(UPWGenerator.EVENT_4_MAIN_OFFENCE)
        save(UPWGenerator.EVENT_5_MAIN_OFFENCE)
        save(UPWGenerator.EVENT_6_MAIN_OFFENCE)
        save(UPWGenerator.EVENT_7_MAIN_OFFENCE)
        ...
        save(UPWGenerator.DISPOSAL_6)
        save(UPWGenerator.DISPOSAL_7)
        ...
        save(UPWGenerator.UPW_DETAILS_6)
        save(UPWGenerator.UPW_DETAILS_7)
        ...
        save(UPWGenerator.ADJUSTMENT_RQMNT)
