...
interface UpwAppointmentRepository : JpaRepository<UpwAppointment, Long> {
    @Query(
        ...
        from (
            ...
            join upw_project on upw_project.upw_project_id = upw_appointment.upw_project_id and upw_project.code not in :excludedProjects
    ...
    fun getUnpaidWorkAppointments(date: LocalDate, providerCode: String, excludedProjectCodes: List<String>): List<UnpaidWorkAppointment>
}