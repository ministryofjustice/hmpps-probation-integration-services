...
class DataLoader(
    ...
    override fun onApplicationEvent(ape: ApplicationReadyEvent) {
        ...
        entityManager.persist(RegistrationGenerator.MAPPA.type.flag)
        entityManager.persist(RegistrationGenerator.MAPPA.type)
        entityManager.persist(RegistrationGenerator.MAPPA.category)
        entityManager.persist(RegistrationGenerator.MAPPA.level)
        entityManager.persist(RegistrationGenerator.MAPPA)
        entityManager.persist(RegistrationGenerator.HIGH_ROSH.type.flag)
