...
class DocumentService(
    ...
    fun uploadDocument(event: HmppsDomainEvent, file: ByteArray) = audit(BusinessInteractionCode.UPLOAD_DOCUMENT) {
        ...
        val oldAlfrescoId = document.alfrescoId
        alfrescoUploadClient.delete(oldAlfrescoId)
    ...
    private fun updateParent(document: DocumentEntity) {
    ...
    private fun uk.gov.justice.digital.hmpps.entity.DocumentEntity.toMultipart(file: ByteArray) =
