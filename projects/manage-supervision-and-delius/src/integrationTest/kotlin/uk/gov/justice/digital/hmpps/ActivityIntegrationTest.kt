...
internal class ActivityIntegrationTest {
    ...
    fun `all person activity is returned`() {
        ...
        assertThat(res.activities[2].id, equalTo(ContactGenerator.NEXT_APPT_CONTACT.toActivity().id))
        assertThat(res.activities[2].type, equalTo(ContactGenerator.NEXT_APPT_CONTACT.toActivity().type))
        assertThat(
