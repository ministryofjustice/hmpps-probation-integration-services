            ...
            listOf(
                ...
                MinimalSentence(
                    ...
                    licenceConditions = listOf(
                        MinimalLicenceCondition(LC_WITHOUT_NOTES.id, LIC_COND_MAIN_CAT.code, LIC_COND_MAIN_CAT.description, true),
                        MinimalLicenceCondition(LC_WITH_NOTES.id, LIC_COND_MAIN_CAT.code,LIC_COND_MAIN_CAT.description, true),
                        MinimalLicenceCondition(LC_WITH_NOTES_WITHOUT_ADDED_BY.id, LIC_COND_MAIN_CAT.code,LIC_COND_MAIN_CAT.description, true),
                        MinimalLicenceCondition(LC_WITH_1500_CHAR_NOTE.id, LIC_COND_MAIN_CAT.code,LIC_COND_MAIN_CAT.description, true)
                    ),
                    requirements = listOf(
