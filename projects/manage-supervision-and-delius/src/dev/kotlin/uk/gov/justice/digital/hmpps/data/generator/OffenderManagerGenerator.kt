...
object OffenderManagerGenerator {
    ...
    val STAFF_2 = Staff(IdGenerator.getAndIncrement(), "Bruce", "Wayne", DEFAULT_PROVIDER, startDate = LocalDate.now().minusDays(1))
    val STAFF_3 = Staff(IdGenerator.getAndIncrement(), "Clark", "Kent", DEFAULT_PROVIDER, startDate = LocalDate.now().minusDays(2))
