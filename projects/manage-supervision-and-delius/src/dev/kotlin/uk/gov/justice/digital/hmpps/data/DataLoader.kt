...
class DataLoader(dataManager: DataManager, private val jdbcTemplate: JdbcTemplate) : BaseDataLoader(dataManager) {
    ...
    override fun setupData() {
        ...
        saveAll(
            ...
            OffenderManagerGenerator.STAFF_USER_W01_HOME,
            ...
            ContactGenerator.ENFORCEMENT_APPOINTMENT_CONTACT,
            ContactGenerator.ENFORCEMENT_APPOINTMENT_ENFORCEMENT,
            ...
            PersonGenerator.NSI_RECALL_TYPE,
            PersonGenerator.NSI_OPD_TYPE,
            PersonGenerator.NSI_OPD_SUB_TYPE,
            PersonGenerator.NSI_STATUS,
            PersonGenerator.RECALL_STATUS,
            PersonGenerator.BREACH_PREVIOUS_ORDER_1,
            PersonGenerator.BREACH_PREVIOUS_ORDER_2,
            PersonGenerator.BREACH_ON_ACTIVE_ORDER,
            PersonGenerator.RECALL_NSI,
            PersonGenerator.INACTIVE_RECALL_NSI,
            PersonGenerator.OPD_NSI,
            MonthsFilterGenerator.NSI_BREACH_TYPE,
            MonthsFilterGenerator.NSI_STATUS,
            MonthsFilterGenerator.RECENT_BREACH,
            MonthsFilterGenerator.OLD_BREACH,
        ...
        saveAll(
            ...
            UpdateContactOutcomeGenerator.PERSON_LEVEL_ENFORCEMENT_ACTION,
            UpdateContactOutcomeGenerator.PERSON_LEVEL_ENFORCEMENT_ACTION_OUTCOME_TYPE,
    ...
    fun personalDetailsData() {
        saveAll(
            ...
            PersonDetailsGenerator.DISABILITY_3_RD,
            PersonDetailsGenerator.CONDITION_1_RD,
            ...
            PersonDetailsGenerator.DISABILITY_3,
