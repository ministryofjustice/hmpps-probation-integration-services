...
FROM OFFENDER o
         ...
         LEFT OUTER JOIN OFFENDER_ADDRESS a ON a.OFFENDER_ID = o.OFFENDER_ID AND a.SOFT_DELETED = 0
         LEFT OUTER JOIN R_STANDARD_REFERENCE_LIST ast ON ast.STANDARD_REFERENCE_LIST_ID = a.ADDRESS_STATUS_ID AND ast.CODE_VALUE = 'M'
WHERE
