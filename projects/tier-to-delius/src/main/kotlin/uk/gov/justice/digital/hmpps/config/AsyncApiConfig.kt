...
class AsyncApiConfig {
    ...
    fun asyncApiExtension(asyncApiCommonInfo: AsyncApiExtension) = AsyncApiExtension.builder(order = 1) {
        info.title("tier-to-delius")
        info.description("Reflect new management tier calculations in Delius")
        servers {
            server("dev") {
        ...
        externalDocs {
            url("https://ministryofjustice.github.io/hmpps-probation-integration-services/tech-docs/projects/tier-to-delius/")
        }
    }
}
