...
class DataLoaderForAPI(dataManager: DataManager) : BaseDataLoader(dataManager) {
    override fun setupData() {
        ...
        save(ReferenceDataSetGenerator.REGISTER_CATEGORY)
        ...
        save(ReferenceDataGenerator.CATEGORY_ONE)
        ...
        save(EventGenerator.RECALLED)
        save(DisposalGenerator.RECALLED)
        save(CustodyGenerator.RECALLED)
