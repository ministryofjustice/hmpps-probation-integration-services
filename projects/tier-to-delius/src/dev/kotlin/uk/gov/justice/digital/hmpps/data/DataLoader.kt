...
class DataLoader(
    ...
    override fun setupData() {
        ...
        save(EventGenerator.generate(save(PersonGenerator.generate("A000001"))))
        save(EventGenerator.generate(save(PersonGenerator.generate("A000002"))))
        save(EventGenerator.generate(save(PersonGenerator.generate("A000003"))))
        save(EventGenerator.generate(save(PersonGenerator.generate("A000004"))))
        save(EventGenerator.generate(save(PersonGenerator.generate("A000005"))))
