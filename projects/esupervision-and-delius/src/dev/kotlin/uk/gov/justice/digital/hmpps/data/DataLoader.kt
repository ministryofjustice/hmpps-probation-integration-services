...
class DataLoader(dataManager: DataManager) : BaseDataLoader(dataManager) {
    ...
    override fun setupData() {
        saveAll(
            ...
            ContactOutcomeGenerator.COT_ESPMP,
            ContactOutcomeGenerator.COT_ESPNA,
            ContactOutcomeGenerator.COT_ESPRS,
            ...
            PersonGenerator.NO_ACTIVE_EVENT_PERSON,
            ...
            EventGenerator.SENSITIVE_CONTACT_EVENT,
            OffenceGenerator.BURGLARY,
            EventGenerator.EVENT_1,
            EventGenerator.EVENT_2,
            EventGenerator.EVENT_3,
