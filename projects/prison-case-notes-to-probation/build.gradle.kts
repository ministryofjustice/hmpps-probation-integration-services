...
dependencies {
    ...
    dev("org.springframework.boot:spring-boot-starter-artemis")
    dev("org.apache.activemq:artemis-jms-server")
    dev("org.apache.activemq:artemis-plugin:${dependencyManagement.importedProperties["artemis.version"]}")
