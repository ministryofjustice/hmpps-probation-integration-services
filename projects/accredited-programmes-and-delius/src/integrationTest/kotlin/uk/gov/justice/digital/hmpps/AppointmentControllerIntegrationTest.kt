                        ...
                        "A000001": [
                            {
                              ...
                              "startTime": "${
                        ZonedDateTimeDeserializer.formatter.format(TestData.APPOINTMENTS[0].startTime).substring(0, 25)
                    }",
                              "endTime": "${
                        ZonedDateTimeDeserializer.formatter.format(TestData.APPOINTMENTS[0].endTime).substring(0, 25)
                    }",
                              "staff": {
                                "name": {
                                  "forename": "Forename",
                            ...
                            },
                            {
                              ...
                              "startTime": "${
                        ZonedDateTimeDeserializer.formatter.format(TestData.APPOINTMENTS[2].startTime).substring(0, 25)
                    }",
                              "endTime": "${
                        ZonedDateTimeDeserializer.formatter.format(TestData.APPOINTMENTS[2].endTime).substring(0, 25)
                    }",
                              "staff": {
                                "name": {
                                  "forename": "Forename",
                            ...
                            },
                            {
                              ...
                              "startTime": "${
                        ZonedDateTimeDeserializer.formatter.format(TestData.APPOINTMENTS[1].startTime).substring(0, 25)
                    }",
                              "endTime": "${
                        ZonedDateTimeDeserializer.formatter.format(TestData.APPOINTMENTS[1].endTime).substring(0, 25)
                    }",
                              "staff": {
                                "name": {
                                  "forename": "Forename",
                            ...
                            },
                            {
                              ...
                              "startTime": "${
                        ZonedDateTimeDeserializer.formatter.format(TestData.APPOINTMENTS[3].startTime).substring(0, 25)
                    }",
                              "endTime": "${
                        ZonedDateTimeDeserializer.formatter.format(TestData.APPOINTMENTS[3].endTime).substring(0, 25)
                    }",
                              "staff": {
                                "name": {
                                  "forename": "Forename",
