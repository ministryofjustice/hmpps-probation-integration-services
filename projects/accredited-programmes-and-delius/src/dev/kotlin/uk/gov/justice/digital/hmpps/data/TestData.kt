...
object TestData {
    ...
    val PDU = ProbationDeliveryUnit(id(), "PDU1", "Test PDU", PROVIDER)
    val PDU_2 = ProbationDeliveryUnit(id(), "PDU2", "A Second PDU", PROVIDER)
    val LAU = LocalAdminUnit(id(), "LAU01", "Test LAU", PDU)
    val LAU_2 = LocalAdminUnit(id(), "LAU02", "A Second LAU", PDU_2)
    val INACTIVE_PROVIDER = Provider(id(), "IPA", "Inactive Provider", selectable = false)
    val PDU_IN_INACTIVE_PROVIDER = ProbationDeliveryUnit(id(), "IPDU", "Test PDU", INACTIVE_PROVIDER)
    val AP_PROVIDER = Provider(id(), "N07", "London")
    val AP_PDU = ProbationDeliveryUnit(id(), "N07PDU", "London PDU", AP_PROVIDER)
    val AP_LAU = LocalAdminUnit(id(), "N07ACPR", "Accredited Programmes", AP_PDU)
