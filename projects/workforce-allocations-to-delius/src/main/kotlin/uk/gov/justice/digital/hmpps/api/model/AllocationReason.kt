...
data class DeliusCodes(
    ...
    fun forType(type: AllocationType): String = when (type) {
        ...
        AllocationType.LICENCE_CONDITION -> licenceCondition
    }
}
...
val ALLOCATION_REASON_TO_DELIUS: Map<AllocationReason, DeliusCodes> = mapOf(
    ...
    AllocationReason.OTHER to DeliusCodes("OTH", "OTH", "OTH", "OTH"),
    AllocationReason.RISK_TO_STAFF to DeliusCodes("RTS", "RTS", "RTS", "RTS"),
    AllocationReason.TRANSFER_IN to DeliusCodes("TIN", "TIN", "TIN", "TIN"),
    AllocationReason.PROBATION_RESET to DeliusCodes("RESET", "RESET", "RESET", "RESET"),
    AllocationReason.INITIAL_ALLOCATION to DeliusCodes("IN1", "INT", "IN1", "IN1"),
)
