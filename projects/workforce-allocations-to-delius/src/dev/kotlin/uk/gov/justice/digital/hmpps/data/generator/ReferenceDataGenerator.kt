...
object ReferenceDataGenerator {
    ...
    val INITIAL_LC_ALLOCATION = generate(DatasetGenerator.LM_ALLOCATION_REASON, "IN1")
    val REALLOCATION_ORDER_ALLOCATION = generate(DatasetGenerator.ORDER_ALLOCATION_REASON, "OA01")
    val REALLOCATION_OM_ALLOCATION = generate(DatasetGenerator.OM_ALLOCATION_REASON, "AR03")
    val REALLOCATION_RM_ALLOCATION = generate(DatasetGenerator.RM_ALLOCATION_REASON, "OM")
    val REALLOCATION_LC_ALLOCATION = generate(DatasetGenerator.LM_ALLOCATION_REASON, "OM")
    ...
    val LICENCE_CONDITION_SUB_CATEGORY =
        generate(DatasetGenerator.REQUIREMENT_SUB_CATEGORY, "LC_SUB", "Lic Condition Sub Category")
