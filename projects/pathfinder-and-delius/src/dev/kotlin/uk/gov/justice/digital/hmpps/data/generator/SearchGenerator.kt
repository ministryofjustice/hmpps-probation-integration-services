...
object SearchGenerator {
    ...
    val JOHN_SMITH_1 = generatePerson("S223456", "John", "Smith", LocalDate.of(1998, 1, 1), nomsId = "S3478CH", gender = MALE)
    val JOHN_SMITH_2 = generatePerson("S223457", "John", "Smith", LocalDate.of(1998, 12, 12), nomsId = "S3479CH", gender = MALE)
