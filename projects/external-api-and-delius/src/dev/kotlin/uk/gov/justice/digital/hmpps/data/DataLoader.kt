...
class DataLoader(dataManager: DataManager) : BaseDataLoader(dataManager) {
    ...
    override fun setupData() {
        ...
        save(RegistrationGenerator.SUICIDE_SELFHARM_TYPE)
        save(RegistrationGenerator.WARRANT_SUMMONS_TYPE)
        save(RegistrationGenerator.RISK_TO_CHILDREN_TYPE)
        save(RegistrationGenerator.RISK_TO_KNOWN_ADULT_TYPE)
        save(RegistrationGenerator.RISK_TO_PRISONER_TYPE)
        save(RegistrationGenerator.RISK_TO_PUBLIC_TYPE)
        save(RegistrationGenerator.RISK_TO_STAFF_TYPE)
        save(RegistrationGenerator.generate(RegistrationGenerator.SERIOUS_FURTHER_OFFENCE_TYPE))
        save(RegistrationGenerator.generate(RegistrationGenerator.SUICIDE_SELFHARM_TYPE))
        save(RegistrationGenerator.generate(RegistrationGenerator.WARRANT_SUMMONS_TYPE))
        save(RegistrationGenerator.generate(RegistrationGenerator.RISK_TO_CHILDREN_TYPE))
        save(RegistrationGenerator.generate(RegistrationGenerator.RISK_TO_KNOWN_ADULT_TYPE))
        save(RegistrationGenerator.generate(RegistrationGenerator.RISK_TO_PRISONER_TYPE))
        save(RegistrationGenerator.generate(RegistrationGenerator.RISK_TO_PUBLIC_TYPE))
        save(RegistrationGenerator.generate(RegistrationGenerator.RISK_TO_STAFF_TYPE))
