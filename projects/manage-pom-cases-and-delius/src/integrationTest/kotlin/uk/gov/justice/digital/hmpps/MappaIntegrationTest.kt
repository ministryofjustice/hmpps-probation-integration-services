...
internal class MappaIntegrationTest @Autowired constructor(
    private val mockMvc: MockMvc
) {

    @Test
    fun `successful retrieval of mappa detail`() {
        val mappa = mockMvc.get("/case-records/T123456/risks/mappa") { withToken() }
    ...
    fun `mappa person not found`() {
        val mappa = mockMvc.get("/case-records/W123456/risks/mappa") { withToken() }
            .andExpect { status { isNotFound() } }
            .andReturn().response.contentAsJson<ErrorResponse>()
