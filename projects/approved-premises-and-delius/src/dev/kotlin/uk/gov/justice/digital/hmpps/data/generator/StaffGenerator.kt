...
object StaffGenerator {
    ...
    val CAS2V2_DELIUS_CB = generate(
        name = "Coutney Delius-Bail"
    )
    val CAS2V2_DELIUS_PB = generate(
    ...
    val CAS2V2_DELIUS_CB_USER = generateStaffUser("CAS2V2_DELIUS_CB", CAS2V2_DELIUS_CB)
    val CAS2V2_DELIUS_PB_USER = generateStaffUser("CAS2V2_DELIUS_PB", CAS2V2_DELIUS_PB)
