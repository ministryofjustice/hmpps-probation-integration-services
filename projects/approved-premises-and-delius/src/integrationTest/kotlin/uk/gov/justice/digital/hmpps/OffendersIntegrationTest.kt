...
class OffendersIntegrationTest(
    ...
    fun `returns offender details for a crn`() {
        ...
        assertThat(offenderProfile.gender, equalTo("Male"))
        assertThat(offenderProfile.genderIdentity, equalTo("Prefer not to say"))
        assertThat(offenderProfile.selfDescribedGender, equalTo("Female"))
