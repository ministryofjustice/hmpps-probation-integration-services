...
class CaseController(private val caseService: CaseService, private val registrationService: RegistrationService) {
    ...
    @GetMapping(value = ["/{crn}/sexual-offence-registrations"])
