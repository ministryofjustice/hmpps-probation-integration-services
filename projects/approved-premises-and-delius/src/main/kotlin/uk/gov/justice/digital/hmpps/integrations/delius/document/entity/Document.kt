...
class AssessmentDocument(
    ...
    override fun findRelatedTo(): RelatedTo =
        RelatedTo(
            ...
            docAssessment?.type?.description ?: ENTITY_NOT_FOUND,
...
class CourtReportDocument(
    ...
    override fun findRelatedTo(): RelatedTo =
        RelatedTo(
            ...
            courtReportDoc?.type?.description ?: ENTITY_NOT_FOUND,
...
class InstitutionalReportDocument(
    ...
    override fun findRelatedTo(): RelatedTo = RelatedTo(RelatedType.INSTITUTIONAL_REPORT, institutionalReport?.type?.description ?: ENTITY_NOT_FOUND)
}
...
class NsiDocument(
    ...
    override fun findRelatedTo(): RelatedTo =
        RelatedTo(
            RelatedType.NSI,
            docNsi?.type?.description ?: ENTITY_NOT_FOUND,
...
class PersonalCircumstanceDocument(
    ...
    override fun findRelatedTo(): RelatedTo = RelatedTo(RelatedType.PERSONAL_CIRCUMSTANCE, getCircName())
...
class PersonalContactDocument(
    ...
    override fun findRelatedTo(): RelatedTo = RelatedTo(RelatedType.PERSONAL_CONTACT, getPersonalContactLine())
...
class ReferralDocument(
    ...
    override fun findRelatedTo(): RelatedTo =
        RelatedTo(
            ...
            docReferral?.type?.description ?: ENTITY_NOT_FOUND,
...
class RegistrationDocument(
    ...
    override fun findRelatedTo(): RelatedTo = RelatedTo(RelatedType.REGISTRATION, registration?.type?.description ?: ENTITY_NOT_FOUND)
}
