...
internal class CaseDetailsTest {
    ...
    fun `correctly calculates age at release`(
        details: CaseDetails,
        ageAtRelease: Long?,
    ) {
    ...
    companion object {
        ...
        private fun CaseDetails.withReleaseDate(releaseDate: LocalDate) = copy(sentence = this.sentence?.copy(releaseDate = releaseDate))
