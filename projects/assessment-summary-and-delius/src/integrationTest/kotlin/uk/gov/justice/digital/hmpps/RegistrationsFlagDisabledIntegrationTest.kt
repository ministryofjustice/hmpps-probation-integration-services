...
@SpringBootTest
@DirtiesContext
internal class RegistrationsFlagDisabledIntegrationTest @Autowired constructor(
    ...
    fun setUp() {
        ...
        whenever(featureFlags.enabled("assessment-summary_update-risk-registrations-in-place")).thenReturn(false)
    }
