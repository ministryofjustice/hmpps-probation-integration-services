...
class RiskAssessmentService(
    ...
    private val flaggedOgrsAssessmentRepository: FlaggedOGRSAssessmentRepository,
    ...
    fun addOrUpdateRiskAssessment(
        ...
        val ogrsAssessment = flaggedOgrsAssessmentRepository.findByEvent(event)
        if (ogrsAssessment != null) {
            if (assessmentDate.toLocalDate() > ogrsAssessment.assessmentDate) {
                ...
                flaggedOgrsAssessmentRepository.save(ogrsAssessment)
            ...
            flaggedOgrsAssessmentRepository.findByEvent(event)?.let { throw ConflictException("Assessment has been created") }
            flaggedOgrsAssessmentRepository.save(
                FlaggedOGRSAssessment(
                    0,
